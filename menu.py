...
class Menu():
    ...
    def update(self, window):
        ...
        for j, t in enumerate(self.menu_text):
            ...
            window.blit(text_surface, (300,  150 + j * 60))
            
        # pygame.draw.circle(window, WHITE, (xs[i], ys[i]), 10, 0)
        pygame.draw.rect(window, (255,255,255), (self.xs[self.i], self.ys[self.i], 400, 60), 1)
